...
mod.command.message('<font color="#00bfe6">Eklipse-Schuhe(Non Stat)</font>')
else if(event.item === 89682)
mod.command.message('<font color="#00bfe6">Eklipse-Schuhe(1 Stat)</font>')
else if(event.item === 89683)
mod.command.message('<font color="#00bfe6">Eklipse-Schuhe(2 Stats)</font>')
else if(event.item === 89684)
mod.command.message('<font color="#00bfe6">Eklipse-Schuhe(3 Stats)</font>')
